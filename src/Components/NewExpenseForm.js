...
class NewExpenseForm extends React.Component{
    ...
    backClickHandler = () => {
        ...
        //need to set something in redux to true/false that the expense container is listening to 
    }
    addExpense = () => {
        ...
        //need to strinify date 
        //need to parse amount
        //if everything is filled out do the stuff
        //save will also have to call this.props.hideexpenseform or not because container is listening for user
    }
